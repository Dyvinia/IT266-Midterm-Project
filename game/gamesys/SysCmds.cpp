...
void Cmd_Rev_f(const idCmdArgs& args) {
	idPlayer* player;
...
// RAVEN END
	cmdSystem->AddCommand( "oct",					Cmd_Octane_f,				CMD_FL_GAME,				"changes legend to octane");
	...
	cmdSystem->AddCommand( "rev",					Cmd_Rev_f,					CMD_FL_GAME,				"changes legend to revenant");
